...
| DATE | PLAN | LINK |
| --------- | ---------------------- | ---------------------- |
| 22.03.11 (금) | 9:30까지 완성된 제출파일을( .ipynb) 깃허브에 올리고 깃허브 링크제출하기 | 완성본 - [🗃️](https://github.com/junnnn-a/DATATHON_22_03_11/blob/main/code/Datathon_finished_version.ipynb) |
